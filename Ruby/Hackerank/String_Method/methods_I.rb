...
# String.chomp(separator=$/):
  # Returns a new string with the given separator removed from the end of the string (if present).
...
# which takes an array of strings as input and returns a single joined string 
