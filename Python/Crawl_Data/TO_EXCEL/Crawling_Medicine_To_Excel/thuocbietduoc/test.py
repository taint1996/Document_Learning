...
class ThuocBietDuoc:
  ...
  def create_excel_file(sheet_name, excel_name):
    ...
    while i < len(headers):
      ...
      a = sheet.write(0, i, headers[i], style)
      i = i + 1
  ...
  def save_detail_drug_to_excel(sheet, line, detail_url):
    ...
    with requests.Session() as s:
      ...
      ThuocBietDuoc.save_text_to_excel(sheet, nhom_thuoc, line, 1)
      ...
      ThuocBietDuoc.save_text_to_excel(sheet, ten_thuoc, line, 2)
      ...
      if not img:
        ...
        img = img.get("src")
      ThuocBietDuoc.save_text_to_excel(sheet, img, line, 3)
